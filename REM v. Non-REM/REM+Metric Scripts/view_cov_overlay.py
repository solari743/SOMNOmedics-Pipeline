# ===============================================================
# CONTINUOUS SLEEP COV PLOT (With Sleep State Legend)
# ===============================================================
# 1. Cleans accelerometer data (clip, detrend, low-pass)
# 2. Computes Coefficient of Variation (30s epochs)
...
cov_30s = acc_df['mag'].resample('30s').apply(cov_func).dropna()
...
ax.plot(cov_30s.index, cov_30s.values, color='magenta', lw=1.5, label='Coefficient of Variation (unitless)')
...
legend_elements.append(Patch(facecolor='magenta', alpha=0.5, label='CoV'))
ax.legend(handles=legend_elements, loc='upper right')

ax.set_title("Continuous Coefficient of Variation — Sleep States Highlighted", fontsize=14, weight='bold')
ax.set_xlabel("Time (HH:MM:SS)")
ax.set_ylabel("Coefficient of Variation (unitless)")
ax.grid(True)
