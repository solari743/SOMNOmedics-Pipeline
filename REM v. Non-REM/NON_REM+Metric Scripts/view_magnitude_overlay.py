# ===============================================================
# CONTINUOUS WAKE MAGNITUDE PLOT (No Slider)
# ===============================================================
# 1. Cleans accelerometer data (clip, detrend, low-pass)
# 2. Computes mean acceleration magnitude per 30s epoch
# 3. Aligns with sleep file and isolates Wake periods
# 4. Plots one continuous timeline of wake data
...
ax.plot(mag_30s.index, mag_30s.values, color='blue', lw=1.5, label='Mean Acceleration Magnitude (m/s²)')
...
ax.set_title("Continuous Mean Acceleration Magnitude — Wake Segments Highlighted", fontsize=14, weight='bold')
