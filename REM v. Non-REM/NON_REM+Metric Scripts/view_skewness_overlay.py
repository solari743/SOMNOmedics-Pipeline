# ===============================================================
# CONTINUOUS WAKE SKEWNESS PLOT (No Slider)
# ===============================================================
...
#    - Vertical dashed lines = Wake segment boundaries
#    - Labels show start/end clock times
# ===============================================================
...
ax.set_title("Continuous Skewness of Motion Magnitude — Wake Segments Highlighted", fontsize=14, weight='bold')
