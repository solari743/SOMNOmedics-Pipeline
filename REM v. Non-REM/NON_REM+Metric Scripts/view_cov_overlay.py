# ===============================================================
# CONTINUOUS WAKE COV PLOT (No Slider)
# ===============================================================
...
#    - Vertical dashed lines = Wake segment start boundaries
#    - Labels show start clock times
# ===============================================================
...
ax.set_title("Continuous Coefficient of Variation — Wake Segments Highlighted", fontsize=14, weight='bold')
